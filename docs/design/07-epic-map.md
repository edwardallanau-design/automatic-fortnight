...
- **Business hours / order-acceptance toggle** — staff or admin can open or close the venue for new incoming orders (e.g. a "closed" state that blocks new order submission outside operating hours). Raised 2026-07-08. **In progress** as of 2026-07-09 — see `BUILD_STATUS.md` Story 17 and `docs/superpowers/specs/2026-07-09-business-hours-and-staff-sold-out-design.md`; will be pruned from this list once Done, per this project's convention for backlog items that get built.
